...
/*
* FitVids 1.0.3 Specific Extension for blog posts
*/
!function(n){n(document).ready(function(){n(".post").fitVids()})}(jQuery);
/*
  OF COURSE, Microsoft had to diddle us on edge vs IE which they insist is a different browser but I highly doubt it sometimes.
  Anyway this is disabled now to maintain Edge compatibility, no idea if this still works on IE, bleh.
*/
